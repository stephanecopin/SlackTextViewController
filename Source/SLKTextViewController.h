...
/** The insets for the scroll view/collection view/table view. Do not use its contentInsets directly. */
@property (nonatomic, readonly) UIEdgeInsets viewContentInsets;

/** The scroll insets for the scroll view/collection view/table view. Do not use its scrollIndicatorInsets directly. */
@property (nonatomic, readonly) UIEdgeInsets viewScrollIndicatorInsets;
