 ...
 */
- (void)slk_animateLayoutIfNeededWithBounce:(BOOL)bounce options:(UIViewAnimationOptions)options animations:(nullable void (^)(void))animations;

- (void)slk_animateLayoutIfNeededWithBounce:(BOOL)bounce options:(UIViewAnimationOptions)options animations:(nullable void (^)(void))animations completion:(nullable void (^)(BOOL finished))completion;
...
/**
 ...
 @param animations An additional block for custom animations.
 */
- (void)slk_animateLayoutIfNeededWithDuration:(NSTimeInterval)duration bounce:(BOOL)bounce options:(UIViewAnimationOptions)options animations:(nullable void (^)(void))animations completion:(nullable void (^)(BOOL finished))completion;
...
/**
 ...
 @param animations An additional block for custom animations.
 */
- (void)slk_animateWithBounce:(BOOL)bounce options:(UIViewAnimationOptions)options animations:(void (^)(void))animations completion:(nullable void (^)(BOOL))completion;
...
/**
 ...
 @param animations An additional block for custom animations.
 */
- (void)slk_animateWithDuration:(NSTimeInterval)duration bounce:(BOOL)bounce options:(UIViewAnimationOptions)options animations:(void (^)(void))animations completion:(nullable void (^)(BOOL finished))completion;
 ...
 */
- (nullable NSLayoutConstraint *)slk_constraintForAttribute:(NSLayoutAttribute)attribute firstItem:(id)first secondItem:(nullable id)second;
